...
# Constants
CHROMA_PATH = "../data/chroma_snowflake"  # Replace with your Chroma directory path
...
def evaluate_rag_system(query_text, expected_keywords):
    try:
        ...
        query_embedding = np.array(embedding_function.embed_query(query_text))

        # Initialize Chroma (it handles FAISS internally)
